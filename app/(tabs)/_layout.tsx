      ...
      >
        <Tabs.Screen
          ...
          options={{
            title: 'Home',
            tabBarIcon: ({ focused }) => (
              <TabIcon label="Home" active={focused} />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            title: 'Transactions',
            tabBarIcon: ({ focused }) => (
              <TabIcon label="Transactions" active={focused} />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ focused, color }) => (
              <TabIcon label="Compass" active={focused} color={color} />
            ),
          }}
        />
        <Tabs.Screen name="challenges" options={{ href: null }} />
        <Tabs.Screen name="future-forecast" options={{ href: null }} />
      </Tabs>

      {/* GLOBAL CHATBOT – renders across entire app */}
      <AiChatbot />
    </View>
  );
}